 ...
 *
 * npx sequelize-cli model:generate --name User --attributes name:string,email:string,noHp:string,alamat:string,KecamatanId:integer,KelurahanId:integer,rt:integer,rw:integer,role:string,password:string
