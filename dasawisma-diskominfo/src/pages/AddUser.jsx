            ...
            <div className="mt-8 lg:w-1/2 lg:mt-0 ">
              ...
              <form className="w-full lg:max-w-xl ">
                ...
                <div className="relative flex items-center mt-4">
                  ...
                  <datalist name="selectRole" id="selectRoleList">
                ...
                <div className="mt-8 md:flex md:items-center">
                  <button className="block w-full px-10 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                    Create User
                  </button>
                </div>
              </form>
